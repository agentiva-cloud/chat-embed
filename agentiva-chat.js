// Agentiva – Vollbild-Chat (JS) – erzeugt UI + Logik dynamisch
(function(){
  ...
  // Avatar-Bild optional setzen
  const brandStyle = document.createElement("style");
  brandStyle.textContent = `.ag-msg.bot::before{background-image:url("https://framer.com/m/Agentiva-teal-Chat-Logo-0G9b.js@Q2sj4SGqi6ySJQXTpqc3");}`;
  ...
  // Minimaler Demo-Funnel (optional)
  demo?.addEventListener("click", ()=>{
    ...
    function cleanup(){ text.removeEventListener("keydown", handler); send.removeEventListener("click", handler); }
    text.addEventListener("keydown", handler); send.addEventListener("click", handler);
  });
